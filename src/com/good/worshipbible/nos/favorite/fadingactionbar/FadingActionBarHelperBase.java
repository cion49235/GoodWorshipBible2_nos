 ...
 */
package com.good.worshipbible.nos.favorite.fadingactionbar;
...
import com.good.worshipbible.nos.favorite.fadingactionbar.view.ObservableScrollView;
import com.good.worshipbible.nos.favorite.fadingactionbar.view.ObservableWebViewWithHeader;
import com.good.worshipbible.nos.favorite.fadingactionbar.view.OnScrollChangedCallback;
...
public abstract class FadingActionBarHelperBase {
    ...
    private View createWebView() {
        ViewGroup webViewContainer = (ViewGroup) mInflater.inflate(R.layout.favorite_fab__webview_container, null);
    ...
    private View createScrollView() {
        ViewGroup scrollViewContainer = (ViewGroup) mInflater.inflate(R.layout.favorite_fab__scrollview_container, null);
    ...
    private View createListView(ListView listView) {
        ViewGroup contentContainer = (ViewGroup) mInflater.inflate(R.layout.favorite_fab__listview_container, null);
        contentContainer.addView(mContentView);

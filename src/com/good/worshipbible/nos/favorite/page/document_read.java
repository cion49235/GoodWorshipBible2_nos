...
import com.good.worshipbible.nos.favorite.global.Filedw;
...
//Log.i("LongClick", "Clicked");
		...
		View header = getLayoutInflater().inflate(R.layout.favorite_doclist_header,
				null, false);
		...
		header_m_adapter = new HeaderListAdapter(this, R.layout.favorite_doc_header_list, header_m_orders);
		...
		m_adapter = new ListAdapter(this, R.layout.favorite_comment_list, m_orders);
...
//    }
	...
	private class ListAdapter extends ArrayAdapter<List> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (v == null) {
				...
				v = vi.inflate(R.layout.favorite_comment_list, null);
			}
	...
	private class HeaderListAdapter extends ArrayAdapter<HeaderList> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (v == null) {
				LayoutInflater vi = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
				v = vi.inflate(R.layout.favorite_doc_header_list, null);
			}
...
//		}
	...
	protected Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			if (msg.what == -1) {
				if(show_alert) Global.ConnectionError(document_read.this);
			}

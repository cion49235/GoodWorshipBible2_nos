...
public class Sub5_4_ColumData {
	...
	String provider;
	public Sub5_4_ColumData(int _id, String title, String enclosure, String pubDate, String image, String description_title, String provider){
		this._id = _id;
		this.title = title;
